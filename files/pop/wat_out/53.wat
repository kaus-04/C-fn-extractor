(module $53.wasm
  ...
  (func $maxcmp (type 1) (param i32 i32) (result i32)
    ...
    local.get 13
    return)
  (func $maxSubArray (type 1) (param i32 i32) (result i32)
  ...
  (export "maxcmp" (func $maxcmp))
  (export "maxSubArray" (func $maxSubArray))
