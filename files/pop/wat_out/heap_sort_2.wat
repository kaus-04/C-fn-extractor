(module $heap_sort_2.wasm
  ...
  (func $swap (type 6) (param i32 i32)
    ...
    i32.store8
    return)
  (func $heapifyDown (type 6) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $heapifyUp (type 6) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $heapSort (type 6) (param i32 i32)
  ...
  (export "heapifyDown" (func $heapifyDown))
  (export "heapifyUp" (func $heapifyUp))
  ...
  (data $.rodata (i32.const 1024) "test\00../files/pop/sorting/heap_sort_2.c\00arr[i] <= arr[i + 1]\00"))
