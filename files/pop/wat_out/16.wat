(module $16.wasm
  ...
  (import "env" "qsort" (func $qsort (type 0)))
  ...
  (func $cmp (type 2) (param i32 i32) (result i32)
    ...
    local.get 21
    return)
  (func $threeSumClosest (type 3) (param i32 i32 i32) (result i32)
  ...
  (export "cmp" (func $cmp))
  (export "threeSumClosest" (func $threeSumClosest))
