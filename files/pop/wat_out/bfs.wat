(module $bfs.wasm
  ...
  (func $createNode (type 1) (param i32) (result i32)
    ...
    local.get 10
    return)
  (func $createQueue (type 3) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 0
    i32.const 16
  ...
  (func $enqueue (type 5) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $isEmpty (type 1) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 1
    i32.const 16
    ...
    local.get 12
    return)
  (func $pollQueue (type 1) (param i32) (result i32)
    ...
    local.get 10
    return)
  (func $dequeue (type 1) (param i32) (result i32)
  ...
  (export "pollQueue" (func $pollQueue))
  ...
  (data $.rodata (i32.const 1024) "Queue is empty\00%d\00\0aQueue is Full!!\00%d \00Enter destination: \00Edge %d \0aEnter source: \00Enter source of bfs\0a\00Enter the number of edges\0a\00Enter the number of vertices\0a\00Breadth first traversal from vertex %d is:\0a\00"))
