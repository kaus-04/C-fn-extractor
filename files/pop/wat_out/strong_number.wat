(module $strong_number.wasm
  ...
  (func $isStrong (type 2) (param i32) (result i32)
  ...
  (data $.rodata (i32.const 1024) "test\00../files/pop/math/strong_number.c\00isStrong(145)\00!isStrong(543)\00"))
