(module $binary_to_octal.wasm
  ...
  (func $three_digits (type 2) (param i32) (result i32)
  ...
  (export "three_digits" (func $three_digits))
  ...
  (data $.rodata (i32.const 1024) "\0aOctal equivalent is: %d\00Enter the binary no: \00"))
