(module $merge_sort_nr.wasm
  ...
  (func $mergesort (type 2) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $show (type 2) (param i32 i32)
  ...
  (data $.rodata (i32.const 1024) "%d\00%d \00Enter the number of elements: \00Enter the elements:\0a\00Sorted array is as shown:\0a\00\0a\0a\00"))
