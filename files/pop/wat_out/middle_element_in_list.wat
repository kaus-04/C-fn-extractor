(module $middle_element_in_list.wasm
  ...
  (func $printMiddle (type 3) (param i32)
  ...
  (export "printMiddle" (func $printMiddle))
  ...
  (data $.rodata (i32.const 1024) "%d->\00NULL\0a\00The middle element is [%d]\0a\0a\00"))
