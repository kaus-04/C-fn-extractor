(module $insertion_sort.wasm
  ...
  (func $insertionSort (type 6) (param i32 i32)
  ...
  (data $.rodata (i32.const 1024) "test\00../files/pop/sorting/insertion_sort.c\00arr[i] <= arr[i + 1]\00"))
