(module $rselect.wasm
  ...
  (func $swap (type 6) (param i32 i32)
    ...
    i32.store
    return)
  (func $part (type 7) (param i32 i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 82
    return)
  (func $rselect (type 8) (param i32 i32 i32 i32 i32) (result i32)
  ...
  (func $__original_main (type 0) (result i32)
    (local i32 i32 i32 i32 i32 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 0
    i32.const 64
    local.set 1
  ...
  (export "part" (func $part))
  (export "rselect" (func $rselect))
  ...
  (data $.rodata (i32.const 1024) "%d %d\00\0a\0a%d\00"))
