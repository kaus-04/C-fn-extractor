(module $strongly_connected_components.wasm
  ...
  (func $createStack (type 3) (result i32)
    ...
    local.get 7
    return)
  (func $fillOrder (type 4) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $transpose (type 1) (param i32) (result i32)
  ...
  (export "fillOrder" (func $fillOrder))
  ...
  (data $.rodata (i32.const 1024) "%d\00%d \00%d -> \00Enter destination: \00Edge %d \0aEnter source: \00\0a Adjacency list of vertex %d\0a \00Enter the number of edges\0a\00Enter the number of vertices\0a\00The strongly connected conponents are:\0a\00"))
