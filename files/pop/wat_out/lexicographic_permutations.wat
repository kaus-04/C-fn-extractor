(module $lexicographic_permutations.wasm
  ...
  (func $compare (type 2) (param i32 i32) (result i32)
    ...
    local.get 15
    return)
  (func $PrintSortedPermutations (type 3) (param i32)
  ...
  (export "PrintSortedPermutations" (func $PrintSortedPermutations))
  ...
  (elem (;0;) (i32.const 1) func $compare)
  (data $.rodata (i32.const 1024) "%s\00%s\0a\00%d\0a\00Input number out of range: >0 and <1000\0a\00"))
