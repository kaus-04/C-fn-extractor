(module $bucket_sort.wasm
  ...
  (func $BucketSort (type 3) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $getBucketIndex (type 0) (param i32) (result i32)
    ...
    local.get 6
    return)
  (func $printBuckets (type 3) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $InsertionSort (type 0) (param i32) (result i32)
  ...
  (func $__original_main (type 5) (result i32)
    (local i32 i32 i32 i32 i32 i64 i32 i32 i64 i32 i32 i64 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 0
    i32.const 48
    local.set 1
  ...
  (export "BucketSort" (func $BucketSort))
  (export "getBucketIndex" (func $getBucketIndex))
  (export "printBuckets" (func $printBuckets))
  ...
  (data $.rodata (i32.const 1024) "BucketSort\00../files/pop/sorting/bucket_sort.c\00j < NARRAY\00%d \00Bucket[\22%d\22] : \00Initial array\0a\00Sorted array\0a\00Buckets after sorted\0a\00--------------\0a\00\1d\00\00\00\19\00\00\00\ff\ff\ff\ff1\00\00\00\09\00\00\00%\00\00\00\15\00\00\00+\00\00\00"))
