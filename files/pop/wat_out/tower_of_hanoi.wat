(module $tower_of_hanoi.wasm
  ...
  (func $hanoi (type 2) (param i32 i32 i32 i32)
  ...
  (data $.rodata (i32.const 1024) "%d\00Move disk : %d from %c to %c\0a\00Number of disks: \0a\00"))
