(module $ode_forward_euler.wasm
  ...
  (func $exact_solution (type 9) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $forward_euler_step (type 10) (param f64 i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 i32 i32 i32 i32 i32 f64 i32 i32 i32 i32 i32 f64 f64 f64 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 4
    i32.const 32
    local.set 5
    ...
    global.set $__stack_pointer
    return)
  (func $forward_euler (type 11) (param f64 f64 f64 i32 i32) (result f64)
  ...
  (export "forward_euler_step" (func $forward_euler_step))
  (export "forward_euler" (func $forward_euler))
  ...
  (data $.rodata (i32.const 1024) "exact.csv\00forward_euler.csv\00%lg\00w+\00\0aEnter the step size: \00Error! \00\09Time = %.6g ms\0a\00Finding exact solution\0a\00%.4g,%.4g,%.4g\0a\00\00\00\00\00\00\00\00\00\00\00\00\f0?\00\00\00\00\00\00\00\00"))
