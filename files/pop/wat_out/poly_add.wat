(module $poly_add.wasm
  ...
  (func $free_poly (type 0) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $create_polynomial (type 4) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $poly_add (type 4) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $display_polynomial (type 0) (param i32)
  ...
  (func $__original_main (type 5) (result i32)
    ...
    local.get 16
    return)
  (func $test1 (type 4) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $test2 (type 4) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $test3 (type 4) (param i32 i32 i32)
  ...
  (export "free_poly" (func $free_poly))
  (export "create_polynomial" (func $create_polynomial))
  (export "poly_add" (func $poly_add))
  (export "display_polynomial" (func $display_polynomial))
  ...
  (data $.rodata (i32.const 1024) "%d x^%d\00 + \00\0aResultant polynomial:\0a\00\0aFirst Polynomial:\0a\00\0aSecond Polynomial:\0a\00\0a----Test 3----\0a\00\0a----Test 2----\0a\00\0a----Test 1----\0a\00"))
