(module $radix_sort.wasm
  ...
  (func $largest (type 0) (param i32 i32) (result i32)
    ...
    local.get 32
    return)
  (func $RadixSort (type 2) (param i32 i32)
  ...
  (export "RadixSort" (func $RadixSort))
  ...
  (data $.rodata (i32.const 1024) "%d\00Enter the number of elements :: \00Enter the elements :: \00%d  \00The sorted elements are ::  \00The large element %d\0a\00"))
