(module $union_find.wasm
  ...
  (func $find (type 2) (param i32 i32) (result i32)
    ...
    local.get 45
    return)
  (func $join (type 4) (param i32 i32 i32)
  ...
  (data $.rodata (i32.const 1024) "%d \00The array is now: \000 and 3 are groupped together\0a\00Out-of bounds value\0a\00"))
