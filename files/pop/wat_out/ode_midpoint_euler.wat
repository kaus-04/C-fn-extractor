(module $ode_midpoint_euler.wasm
  ...
  (func $exact_solution (type 9) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $midpoint_euler_step (type 10) (param f64 i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 f64 f64 f64 f64 f64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 f64 f64 f64 i32 i32 i32 i32 i32 f64 f64 f64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 i32 i32 i32 i32 i32 f64 i32 i32 i32 i32 i32 f64 f64 f64 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 4
    i32.const 64
    local.set 5
    ...
    global.set $__stack_pointer
    return)
  (func $midpoint_euler (type 11) (param f64 f64 f64 i32 i32) (result f64)
  ...
  (export "midpoint_euler_step" (func $midpoint_euler_step))
  (export "midpoint_euler" (func $midpoint_euler))
  ...
  (data $.rodata (i32.const 1024) "exact.csv\00midpoint_euler.csv\00%lg\00w+\00\0aEnter the step size: \00Error! \00\09Time = %.6g ms\0a\00Finding exact solution\0a\00%.4g,%.4g,%.4g\0a\00\00\00\00\00\00\00\00\00\00\00\f0?\00\00\00\00\00\00\00\00"))
