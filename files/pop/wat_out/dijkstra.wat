(module $dijkstra.wasm
  ...
  (func $print (type 3) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $Dijkstra (type 3) (param i32 i32)
  ...
  (data $.rodata (i32.const 1024) "%d\00%d\09INF\00\0aEnter source:\00Enter weight: \00Enter number of edges: \00Enter number of vertices: \00Enter destination: \00\0aEdge %d \0aEnter source: \00\0aVertex  Distance\0a\00%d\09%d\0a\00")
  (data $.data (i32.const 1188) "\ff\ff\ff\ff"))
