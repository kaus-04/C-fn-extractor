(module $heap_sort.wasm
  ...
  (func $max_heapify (type 3) (param i32 i32 i32)
    ...
    i32.store
    return)
  (func $heapsort (type 4) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $build_maxheap (type 4) (param i32 i32)
  ...
  (export "max_heapify" (func $max_heapify))
  (export "heapsort" (func $heapsort))
  (export "build_maxheap" (func $build_maxheap))
  ...
  (data $.rodata (i32.const 1024) "%d\00Enter number of elements of array\0a\00Sorted Output\0a\00Enter Element %d\0a\00"))
