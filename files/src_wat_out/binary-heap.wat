(module $binary-heap.wasm
  ...
  (func $binary_heap_new (type 0) (param i32 i32) (result i32)
  ...
  (func $binary_heap_cmp (type 4) (param i32 i32 i32) (result i32)
    ...
    local.get 20
    return)
  (func $binary_heap_pop (type 1) (param i32) (result i32)
    ...
    local.get 126
    return)
  (func $binary_heap_num_entries (type 1) (param i32) (result i32)
  ...
  (export "binary_heap_new" (func $binary_heap_new))
  (export "binary_heap_free" (func $binary_heap_free))
  (export "binary_heap_insert" (func $binary_heap_insert))
  (export "__indirect_function_table" (table 0))
  (export "binary_heap_pop" (func $binary_heap_pop))
  (export "binary_heap_num_entries" (func $binary_heap_num_entries))
