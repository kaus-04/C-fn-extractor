(module $sortedarray.wasm
  ...
  (func $sortedarray_get (type 0) (param i32 i32) (result i32)
    ...
    local.get 24
    return)
  (func $sortedarray_length (type 1) (param i32) (result i32)
    ...
    local.get 5
    return)
  (func $sortedarray_new (type 0) (param i32 i32) (result i32)
    ...
    local.get 41
    return)
  (func $sortedarray_free (type 2) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $sortedarray_remove (type 0) (param i32 i32) (result i32)
    ...
    local.get 8
    return)
  (func $sortedarray_remove_range (type 4) (param i32 i32 i32) (result i32)
    ...
    local.get 58
    return)
  (func $sortedarray_insert (type 0) (param i32 i32) (result i32)
